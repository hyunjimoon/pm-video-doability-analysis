...
They can _actually_ prototype the features themselves. This allows them to engage with engineers more naturally—not just by handing them a document, but by **showing** them a working concept."
...
This is true at large companies, and you'll even see it in job descriptions—many now expect PMs to have basic biv-coding skills. This is even more critical at startups and medium-sized companies where engineering resources are limited. There, a PM's skill can shift from just prototyping to actual deployment, with PMs sometimes deploying code directly to the code base."

---

**(02:00) Project Goals & The "No-Code" Prerequisite**

"So, we're excited because this project will give you hands-on prototyping experience—a critical skill for modern PMs. You'll gain a deep understanding of how apps are built, what a 'code base' actually looks like, and you'll get to use the same tools industry leaders are adopting.

Now, you might be thinking: 'Do I need coding skills for this project?' The short answer is **no**. The reason is that we will be leveraging **biv-coding tools**. Biv-coding refers to tools that can translate natural language—just plain English—into working code."
...
With that context, Lovable excels at creating the **first iteration** of your app idea. It works best when you've already done your homework: you have a PRD, you've mapped the customer journey, and you have design ideas. You feed all of this context to Lovable in plain English, and it generates the front-end and code base for your version 1.0—your MLP."
...
Okay, I'll let Lovable run and we'll check back in when the first build—our MLP—is complete."
...
Cursor will now download—or 'clone'—all the files from the GitHub repository to that folder on your computer. Now, you can see that same file structure from Lovable and GitHub, right here in Cursor's file explorer."
...
This was a simple design change, but Cursor can handle major structural changes, too—like adding a 'Delete Contact' button or building entirely new screens based on your customer journey."
...
4. Finally, git push origin main. This is the command that **sends your local changes up to the GitHub repository**. Be careful with this command—it permanently alters your 'main' branch. Make sure your changes are correct before you push.
